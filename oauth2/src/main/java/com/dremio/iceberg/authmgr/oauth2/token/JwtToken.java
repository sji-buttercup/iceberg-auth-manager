 ...
 *
 * <p>This implementation only supports extracting the payload claims. It does not decode nor
...
class JwtToken {
   ...
   *
   * <p>In the general case, the "aud" value is an array of case-sensitive strings, each containing
   * a StringOrURI value. In the special case when the JWT has one audience, the "aud" value MAY be
   * a single case-sensitive string containing a StringOrURI value. The interpretation of audience
   * values is generally application specific. Use of this claim is OPTIONAL.
   */
  @SuppressWarnings("unchecked")
  @Nullable
  public List<String> getAudience() {
    return (List<String>) claims.computeIfAbsent(AUD_CLAIM, k -> payloadFieldValues(AUD_CLAIM));
  }
   ...
   * or equal to the not-before date/time listed in the "nbf" claim.
   *
   * <p>Implementers MAY provide for some small leeway, usually no more than a few minutes, to
   * account for clock skew. Its value MUST be a number containing a <a
   * href="https://datatracker.ietf.org/doc/html/rfc7519#section-2">NumericDate</a> value. Use of
   ...
   * used to determine the age of the JWT. Its value MUST be a number containing a <a
   * href="https://datatracker.ietf.org/doc/html/rfc7519#section-2">NumericDate</a> value. Use of
   * this claim is OPTIONAL.
   */
  @Nullable
   ...
   * "jti" claim can be used to prevent the JWT from being replayed. The "jti" value is a
  ...
  private List<String> payloadFieldValues(@SuppressWarnings("SameParameterValue") String field) {
    JsonNode value = payload.get(field);
    ...
    return OBJECT_MAPPER.convertValue(
        value, OBJECT_MAPPER.getTypeFactory().constructCollectionType(List.class, String.class));
  }
}
