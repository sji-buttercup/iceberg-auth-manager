...
/** A test that exercises Flink with Polaris configured as its own authentication provider. */
public class FlinkPolarisS3IT extends FlinkPolarisS3ITBase {
  ...
  protected Map<String, String> flinkCatalogOptions() {
    return ImmutableMap.<String, String>builder()
        ...
        .put("rest.auth.oauth2.dialect", "iceberg_rest")
        .put("rest.auth.oauth2.scope", "PRINCIPAL_ROLE:ALL")
        .build();
  }
}
