...
/**
 * A test that exercises Flink with Polaris configured with an external authentication provider
 * (Keycloak).
 */
public class FlinkPolarisKeycloakS3IT extends FlinkPolarisS3ITBase {
